...
static const GEnumValue _vnc_connection_encoding_values[] = {
  ...
  { VNC_CONNECTION_ENCODING_LED_STATE, "VNC_CONNECTION_ENCODING_LED_STATE", "led-state" },
  { 0, NULL, NULL }
};
...
static const GEnumValue _vnc_connection_auth_values[] = {
  { (gint)VNC_CONNECTION_AUTH_INVALID, "VNC_CONNECTION_AUTH_INVALID", "invalid" },
  { (gint)VNC_CONNECTION_AUTH_NONE, "VNC_CONNECTION_AUTH_NONE", "none" },
  { (gint)VNC_CONNECTION_AUTH_VNC, "VNC_CONNECTION_AUTH_VNC", "vnc" },
  { (gint)VNC_CONNECTION_AUTH_RA2, "VNC_CONNECTION_AUTH_RA2", "ra2" },
  { (gint)VNC_CONNECTION_AUTH_RA2NE, "VNC_CONNECTION_AUTH_RA2NE", "ra2ne" },
  { (gint)VNC_CONNECTION_AUTH_TIGHT, "VNC_CONNECTION_AUTH_TIGHT", "tight" },
  { (gint)VNC_CONNECTION_AUTH_ULTRA, "VNC_CONNECTION_AUTH_ULTRA", "ultra" },
  { (gint)VNC_CONNECTION_AUTH_TLS, "VNC_CONNECTION_AUTH_TLS", "tls" },
  { (gint)VNC_CONNECTION_AUTH_VENCRYPT, "VNC_CONNECTION_AUTH_VENCRYPT", "vencrypt" },
  { (gint)VNC_CONNECTION_AUTH_SASL, "VNC_CONNECTION_AUTH_SASL", "sasl" },
  { (gint)VNC_CONNECTION_AUTH_ARD, "VNC_CONNECTION_AUTH_ARD", "ard" },
  { (gint)VNC_CONNECTION_AUTH_MSLOGON, "VNC_CONNECTION_AUTH_MSLOGON", "mslogon" },
  { 0, NULL, NULL }
};
