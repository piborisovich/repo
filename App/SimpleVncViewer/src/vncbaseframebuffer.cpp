...
#include "vncbaseframebuffer.hpp"
#include "vncutil.hpp"
                                              ...
                                              GParamSpec *pspec)
{
    ...
    switch (prop_id){
    case PROP_BUFFER:
        priv->buffer = (guint8 *) g_value_get_pointer(value);
    ...
    case PROP_LOCAL_FORMAT:
        ...
        priv->localFormat = (VncPixelFormat *)g_value_dup_boxed(value);
        priv->reinitRenderFuncs = TRUE;
        break;
    ...
    case PROP_REMOTE_FORMAT:
        ...
        priv->remoteFormat = (VncPixelFormat *)g_value_dup_boxed(value);
        priv->reinitRenderFuncs = TRUE;
        break;
    ...
    case PROP_COLOR_MAP:
        ...
        priv->colorMap = (VncColorMap *)g_value_dup_boxed(value);
        priv->reinitRenderFuncs = TRUE;
        break;
...
#define SRC 8
#define DST 8
#include "vncbaseframebufferblt.hpp"
#undef SRC
#undef DST
...
{
    VncFramebufferInterface *iface = (VncFramebufferInterface *)g_iface;
